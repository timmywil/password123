...
*/
(function(e,n,l,g){e.fn.password123=function(a){var b=e.data(this[0],"password123"),c=Array.prototype.slice.call(arguments,1);if(b&&typeof a==="string"&&a.charAt(0)!=="_"&&b[a]){c.unshift(this);return b[a].apply(b,c)}return this.map(function(d,f){return new i._init(f,a,c)})};var m=n.clearTimeout,o=0,i={_init:function(a,b){if(!a.type==="password")return a;var c=this;c.options=e.extend({character:"&#8226;",delay:2E3,prefix:"iField",placeholder:true,placeholderClass:"place",maskInitial:false},b);c.encodedChar=
